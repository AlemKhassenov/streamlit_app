...
if submit_button:
    if uploaded_file is None:
        ...
        # Промпт для ChatGPT
        prompt = "Проанализируй файл с ожидаемыми результатами по обучению учащегося, выяви сильные и слабые стороны на основании анализа, напиши рекомендации для ученика со ссылками на обучающие видео и книги."
